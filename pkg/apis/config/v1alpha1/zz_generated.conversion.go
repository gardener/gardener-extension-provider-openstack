...
func autoConvert_v1alpha1_CSIAttacher_To_config_CSIAttacher(in *CSIAttacher, out *config.CSIAttacher, s conversion.Scope) error {
	...
	out.RetryIntervalStart = (*v1.Duration)(unsafe.Pointer(in.RetryIntervalStart))
	out.RetryIntervalMax = (*v1.Duration)(unsafe.Pointer(in.RetryIntervalMax))
	out.ReconcileSync = (*v1.Duration)(unsafe.Pointer(in.ReconcileSync))
	return nil
}
