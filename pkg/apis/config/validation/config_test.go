...
import (
	...
	. "github.com/gardener/gardener-extension-provider-openstack/pkg/apis/config/validation"
...
var _ = Describe("ControllerConfig validation", func() {
	DescribeTable("",
		func(cfg *config.ControllerConfiguration, matcher gomegatypes.GomegaMatcher) {
			Expect(ValidateControllerConfig(cfg)).To(matcher)
		},
