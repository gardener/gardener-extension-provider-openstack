...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CSI)(nil), (*openstack.CSI)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CSI_To_openstack_CSI(a.(*CSI), b.(*openstack.CSI), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.CSI)(nil), (*CSI)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_CSI_To_v1alpha1_CSI(a.(*openstack.CSI), b.(*CSI), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*Manila)(nil), (*openstack.Manila)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Manila_To_openstack_Manila(a.(*Manila), b.(*openstack.Manila), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.Manila)(nil), (*Manila)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_Manila_To_v1alpha1_Manila(a.(*openstack.Manila), b.(*Manila), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CSI_To_openstack_CSI(in *CSI, out *openstack.CSI, s conversion.Scope) error {
	out.Manila = (*openstack.Manila)(unsafe.Pointer(in.Manila))
	return nil
}

// Convert_v1alpha1_CSI_To_openstack_CSI is an autogenerated conversion function.
func Convert_v1alpha1_CSI_To_openstack_CSI(in *CSI, out *openstack.CSI, s conversion.Scope) error {
	return autoConvert_v1alpha1_CSI_To_openstack_CSI(in, out, s)
}

func autoConvert_openstack_CSI_To_v1alpha1_CSI(in *openstack.CSI, out *CSI, s conversion.Scope) error {
	out.Manila = (*Manila)(unsafe.Pointer(in.Manila))
	return nil
}

// Convert_openstack_CSI_To_v1alpha1_CSI is an autogenerated conversion function.
func Convert_openstack_CSI_To_v1alpha1_CSI(in *openstack.CSI, out *CSI, s conversion.Scope) error {
	return autoConvert_openstack_CSI_To_v1alpha1_CSI(in, out, s)
}
...
func autoConvert_v1alpha1_ControlPlaneConfig_To_openstack_ControlPlaneConfig(in *ControlPlaneConfig, out *openstack.ControlPlaneConfig, s conversion.Scope) error {
	...
	out.CSI = (*openstack.CSI)(unsafe.Pointer(in.CSI))
	return nil
}
...
func autoConvert_v1alpha1_Manila_To_openstack_Manila(in *Manila, out *openstack.Manila, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_Manila_To_openstack_Manila is an autogenerated conversion function.
func Convert_v1alpha1_Manila_To_openstack_Manila(in *Manila, out *openstack.Manila, s conversion.Scope) error {
	return autoConvert_v1alpha1_Manila_To_openstack_Manila(in, out, s)
}

func autoConvert_openstack_Manila_To_v1alpha1_Manila(in *openstack.Manila, out *Manila, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_openstack_Manila_To_v1alpha1_Manila is an autogenerated conversion function.
func Convert_openstack_Manila_To_v1alpha1_Manila(in *openstack.Manila, out *Manila, s conversion.Scope) error {
	return autoConvert_openstack_Manila_To_v1alpha1_Manila(in, out, s)
}
