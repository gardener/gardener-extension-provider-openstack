...
func autoConvert_v1alpha1_CloudProfileConfig_To_openstack_CloudProfileConfig(in *CloudProfileConfig, out *openstack.CloudProfileConfig, s conversion.Scope) error {
	...
	if in.MachineImages != nil {
		...
		*out = make([]openstack.MachineImages, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_MachineImages_To_openstack_MachineImages(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_openstack_CloudProfileConfig_To_v1alpha1_CloudProfileConfig(in *openstack.CloudProfileConfig, out *CloudProfileConfig, s conversion.Scope) error {
	...
	if in.MachineImages != nil {
		...
		*out = make([]MachineImages, len(*in))
		for i := range *in {
			if err := Convert_openstack_MachineImages_To_v1alpha1_MachineImages(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha1_MachineImages_To_openstack_MachineImages(in *MachineImages, out *openstack.MachineImages, s conversion.Scope) error {
	...
	if in.Versions != nil {
		...
		*out = make([]openstack.MachineImageVersion, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_MachineImageVersion_To_openstack_MachineImageVersion(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_openstack_MachineImages_To_v1alpha1_MachineImages(in *openstack.MachineImages, out *MachineImages, s conversion.Scope) error {
	...
	if in.Versions != nil {
		...
		*out = make([]MachineImageVersion, len(*in))
		for i := range *in {
			if err := Convert_openstack_MachineImageVersion_To_v1alpha1_MachineImageVersion(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
