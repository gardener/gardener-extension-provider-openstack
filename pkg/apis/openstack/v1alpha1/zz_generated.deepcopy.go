...
func (in *StorageClassDefinition) DeepCopyInto(out *StorageClassDefinition) {
	*out = *in
	...
	if in.Regions != nil {
		in, out := &in.Regions, &out.Regions
		*out = make([]StorageClassRegion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageClassRegion) DeepCopyInto(out *StorageClassRegion) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageClassRegion.
func (in *StorageClassRegion) DeepCopy() *StorageClassRegion {
	if in == nil {
		return nil
	}
	out := new(StorageClassRegion)
	in.DeepCopyInto(out)
	return out
}
